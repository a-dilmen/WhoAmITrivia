...
import static com.dilmen.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(WhoAmITriviaException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSpringMonoException(WhoAmITriviaException exception){
